...
import pickle
models={}
model_names=['dt','ensemble','knn','demand_pred_dt']
...
def load_models():
    for model_name in model_names:
        models[model_name] = pickle.load(open('models/'+model_name+'.model','rb'))
...
def get_density():
    ...
    pred_data['Count']=models['demand_pred_dt'].predict(pred_data[['PULocationID','day_of_week','hour_of_day']])
    pred_data.dropna()
